...
enum CampaignCommandOp {
    ...
    CAMPAIGN_OP_SPECIAL_EVENT_COUNT = 140,
    CAMPAIGN_OP_SPECIAL_EVENT_ID_AT = 141,
    CAMPAIGN_OP_SPECIAL_EVENT_STATUS = 142,
    CAMPAIGN_OP_SPECIAL_EVENT_STAGE = 143,
    CAMPAIGN_OP_SPECIAL_EVENT_SCHEDULE = 144,
    CAMPAIGN_OP_SPECIAL_EVENT_PERIOD = 145,
    CAMPAIGN_OP_BEGIN_SPECIAL_EVENT_STAGE = 146,

    CAMPAIGN_OP_CHAMPIONSHIP_COUNT = 150,
    CAMPAIGN_OP_CHAMPIONSHIP_ID_AT = 151,
    CAMPAIGN_OP_CHAMPIONSHIP_STATUS = 152,
    CAMPAIGN_OP_CHAMPIONSHIP_ROUND = 153,
    CAMPAIGN_OP_CHAMPIONSHIP_POINTS = 154,
    CAMPAIGN_OP_BEGIN_CHAMPIONSHIP_ROUND = 155,

    CAMPAIGN_OP_SEASON_COUNT = 160,
    CAMPAIGN_OP_SEASON_ID_AT = 161,
    CAMPAIGN_OP_SEASON_STATUS = 162,
    CAMPAIGN_OP_SEASON_EVENT = 163,

    CAMPAIGN_OP_GARAGE_COUNT = 170,
    CAMPAIGN_OP_GARAGE_CAR_ID_AT = 171,
    CAMPAIGN_OP_GARAGE_CAR_STATUS = 172,
    CAMPAIGN_OP_GARAGE_ACQUISITION = 173,
    CAMPAIGN_OP_GARAGE_PART_STATUS = 174,
    CAMPAIGN_OP_GARAGE_SELECT_CAR = 175,
    CAMPAIGN_OP_GARAGE_NEXT_PART_COST = 176
};

enum CampaignGarageStatusFlags {
    CAMPAIGN_GARAGE_OWNED = 1u << 0,
    CAMPAIGN_GARAGE_SELECTED = 1u << 1,
    CAMPAIGN_GARAGE_UNLOCKED = 1u << 2,
    CAMPAIGN_GARAGE_ACQUIRABLE = 1u << 3
};
