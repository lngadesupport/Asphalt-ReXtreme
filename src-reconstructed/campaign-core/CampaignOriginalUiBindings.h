...
enum CampaignOriginalUiFeature {
    ...
    CAMPAIGN_ORIGINAL_UI_FEATURE_PROFILE = 9,
    CAMPAIGN_ORIGINAL_UI_FEATURE_SPECIAL_EVENTS = 10,
    CAMPAIGN_ORIGINAL_UI_FEATURE_CHAMPIONSHIPS = 11,
    CAMPAIGN_ORIGINAL_UI_FEATURE_CAREER_SEASONS = 12,
    CAMPAIGN_ORIGINAL_UI_FEATURE_GARAGE = 13
};
