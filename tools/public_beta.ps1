...
function Update-Beta {
    ...
    $paths = @(
        ...
        "FIX-PROFILE-BETA.cmd",
        "TEST-PROFILE-ONLY.cmd",
        "TEST-PROFILE-OFFLINE.cmd",
        "TEST-OFFLINE-V5.cmd",
        "TEST-OFFLINE-V6.cmd",
        "TEST-OFFLINE-V7.cmd",
        ...
        "tools/campaign_profile_adapter_v2.py",
        "tools/campaign_profile_adapter_v3.py",
        "tools/campaign_profile_adapter_v4.py",
        "tools/test_profile_only.ps1",
        "tools/test_profile_offline.ps1",
        "tools/campaign_offline_surface_v5.py",
        "tools/test_offline_surface_v5.ps1",
        "tools/campaign_offline_lobby_v6.py",
        "tools/test_offline_lobby_v6.ps1",
        "tools/campaign_offline_lobby_v7.py",
        "tools/test_offline_lobby_v7.ps1",
        "tools/campaign_frontend_boot_v1.py",
        "tools/test_frontend_only_boot_v1.ps1",
        "tools/campaign_frontend_garage_v1.py",
