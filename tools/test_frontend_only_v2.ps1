...
$garage=Join-Path $ProjectRoot "tools\campaign_frontend_garage_v2.py"
...
if($LASTEXITCODE-ne0){throw "Frontend-Only Garage v2 apply failed: $LASTEXITCODE"}
...
Write-Host "  generic contains()   : UNTOUCHED"
Write-Host ""
Write-Host "Career:"
