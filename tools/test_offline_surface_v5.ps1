...
$tool=Join-Path $ProjectRoot "tools\campaign_offline_surface_v5.py"
...
$backup=Join-Path $ProjectRoot ("_BETA_DIAGNOSTICS\offline-v5-backup-"+$stamp)
...
Write-Host ""
Write-Host "============================================================"
Write-Host " OFFLINE SURFACE V5 BASELINE READY" -ForegroundColor Green
Write-Host "============================================================"
Write-Host "Profile: local / Phase9-compatible"
Write-Host "NO_INTERNET popup: central filter"
...
Write-Host "  - idade/onboarding local"
Write-Host "  - tutorial conclui"
Write-Host "  - SEM CONEXAO popup nao aparece"
Write-Host ""
