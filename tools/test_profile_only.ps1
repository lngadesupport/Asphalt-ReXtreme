...
$tool=Join-Path $ProjectRoot "tools\campaign_profile_adapter_v3.py"
...
$backup=Join-Path $ProjectRoot ("_BETA_DIAGNOSTICS\profile-only-backup-"+$stamp)
New-Item -ItemType Directory -Force -Path $backup|Out-Null
Copy-Item $ams (Join-Path $backup "AMS.final.bin") -Force
Copy-Item $igp (Join-Path $backup "IGPLib.final.bin") -Force
...
if($LASTEXITCODE-ne0){throw "Profile v3 apply failed: $LASTEXITCODE"}
...
Write-Host ""
Write-Host "============================================================"
Write-Host " PROFILE-ONLY BASELINE READY" -ForegroundColor Green
Write-Host "============================================================"
Write-Host "Garage/Career/Upgrade/Store adapters: NOT APPLIED"
Write-Host "Profile: v3 / Phase9-compatible"
