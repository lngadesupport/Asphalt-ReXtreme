...
$tool=Join-Path $ProjectRoot "tools\campaign_frontend_boot_v1.py"
...
$backup=Join-Path $ProjectRoot ("_BETA_DIAGNOSTICS\frontend-only-boot-v1-"+$stamp)
...
$hash=(Get-FileHash -LiteralPath $igp -Algorithm SHA256).Hash.ToLowerInvariant()
...
Write-Host ""
Write-Host "============================================================"
Write-Host " FRONTEND-ONLY BOOT / PROFILE / LOBBY V1" -ForegroundColor Green
Write-Host "============================================================"
Write-Host ("Campaign Core SHA256: "+$hash)
Write-Host "Legacy service popup wrapper: RETIRED"
Write-Host "Garage/Career/Upgrade/Store: NOT APPLIED"
Write-Host ("Backup anterior: "+$backup)
Write-Host ""
Write-Host "Teste esperado:"
Write-Host "  1. passa da Gameloft"
Write-Host "  2. sem VERIFICANDO PERFIL ONLINE"
Write-Host "  3. sem SEM CONEXAO / NOVAMENTE"
Write-Host "  4. lobby abre e permanece vivo"
Write-Host ""
