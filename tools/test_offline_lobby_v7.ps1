...
$tool=Join-Path $ProjectRoot "tools\campaign_offline_lobby_v7.py"
...
$backup=Join-Path $ProjectRoot ("_BETA_DIAGNOSTICS\offline-v7-backup-"+$stamp)
...
if($LASTEXITCODE-ne0){throw "Offline Lobby v7 apply failed: $LASTEXITCODE"}
...
Write-Host ""
Write-Host "============================================================"
Write-Host " OFFLINE LOBBY V7 BASELINE READY" -ForegroundColor Green
Write-Host "============================================================"
Write-Host "Profile: local / Phase9-compatible"
Write-Host "GS_MessagePopup: untouched"
Write-Host "Lobby errors 0x0BC2 / 0x0FAA: bypassed"
Write-Host "Late NO_INTERNET block: bypassed"
