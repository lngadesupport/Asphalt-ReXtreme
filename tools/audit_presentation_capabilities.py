...
KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "quality": (
        ...
        "depth of field", "depth_of_field", "dof", "shader quality",
        "shader_quality", "effect quality", "effect_quality", "geometry quality",
        "geometry_quality", "view distance", "view_distance", "render scale",
        "render_scale", "dynamic resolution", "dynamic_resolution",
        "ambient occlusion", "ambient_occlusion", "ssao", "postprocess",
        "post process", "post_process", "screen space", "screen_space",
        "car reflection", "car_reflection", "decal", "water quality",
        "water_quality",
    ),
    "camera": (
