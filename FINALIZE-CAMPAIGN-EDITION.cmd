...
call :get tools/campaign_profile_adapter_v3.py tools\campaign_profile_adapter_v3.py || goto :download_fail
...
python.exe "%TOOLS%\campaign_profile_adapter_v3.py" --project-root "%ROOT%"
